...
public class HttpConnection {
	...
	public JSONObject connect(String phpFile, JSONObject json ,  int connectionTimeout,int socketTimeout) throws JSONException{
	...
	JSONArray array=null;
		...
		try {
			...
			URL url = new URL("http://" + Const.IPADDRESS+ "/"+phpFile+".php");
			...
			Log.i("JsonObject di Ritorno:",object.toString(4));
	...
	public JSONArray connectForCatalog(String phpFile, JSONObject json , Handler handler, int connectionTimeout,int socketTimeout) throws JSONException{
		// Preparazione delle informazioni da inviare al server
	JSONObject object=null;
	JSONArray array=null;
		try {
	...
	public JSONArray connectForCataalog(String phpFile, JSONObject json , int connectionTimeout,int socketTimeout) throws JSONException{
		// Preparazione delle informazioni da inviare al server
	JSONObject object=null;
	JSONArray array=null;
		try {
			...
			array= new JSONArray(jsonResult);
			Log.i("JsonArray Ritornato: ",array.toString(4));
